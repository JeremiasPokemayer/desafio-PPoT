const e={data:{currentGame:{computerPlay:"",myPlay:""},history:[{}],puntajes:{puntajeComputer:0,puntajeMe:0}},getState(){return this.data},setMove(e){this.getState().currentGame.myPlay=e},pushToHistory(e){this.getState().history.push(e)},computerPlay(){let e=this.getState(),t=["piedra","papel","tijera"],a=Math.floor(Math.random()*t.length);return e.currentGame.computerPlay=t[a],t[a]},setPuntaje(e){return"Ganaste"==e?this.data.puntajes.puntajeMe++:("Empate"==e&&this.data.puntajes.puntajeMe++,this.data.puntajes.puntajeComputer++),this.data.puntajes.puntajeComputer&&this.data.puntajes.puntajeMe},whoWins:(e,t)=>"tijera"==e&&"papel"==t||"piedra"==e&&"tijera"==t||"papel"==e&&"piedra"==t?"Ganaste":e==t?"Empate":"Perdiste"},t=[{path:/\/welcome/,component:function(e){let t=document.createElement("div");document.createElement("style"),t.innerHTML=`
    ...
    `,t.className="main";let a=t.querySelector(".button-empezar");return a?.addEventListener("click",()=>{e.goTo("/inicio")}),t}},{path:/\/inicio/,component:function(e){let t=document.createElement("div");document.createElement("style"),t.innerHTML=`
      <div class="container-title">
      ...
      `,t.className="main";let a=t.querySelector(".button-jugar");return a?.addEventListener("click",()=>{e.goTo("/game")}),t}},{path:/\/game/,component:function(t){let a=document.createElement("div"),n=document.createElement("div"),i=document.createElement("style"),s=3,r=setInterval(()=>{if(s--,document.getElementById("titleCounter").innerText=s.toString(),0==s){let i;clearInterval(r),a.style.display="none",n.style.display="block";let s=e.data.currentGame.computerPlay,o=e.data.currentGame.myPlay,l=e.whoWins(o,s);e.setPuntaje(l),"piedra"===s?i=document.createElement("custom-piedra"):"papel"===s?i=document.createElement("custom-papel"):"tijera"===s&&(i=document.createElement("custom-tijera")),i.style.transform="rotate(180deg)",n.style.justifyContent="space-between",n.style.height="100vh",n.style.alignItems="center",n.style.flexDirection="column-reverse",n.style.display="flex",n.appendChild(i),setTimeout(()=>{n.style.display="none",t.goTo("/result")},3e3)}},1e3);a.innerHTML=`
  ...
  `,document.body.appendChild(a);let o=document.getElementById("tijera"),l=document.getElementById("papel"),p=document.getElementById("piedra");return o.addEventListener("click",()=>{o.style.transform="translate(0px, -70px)",o.style.opacity="1",l.style.transform="translate(0px, 40px)",l.style.opacity="0.5",p.style.transform="translate(0px, 40px)",p.style.opacity="0.5";let t=document.createElement("custom-tijera");e.setMove("tijera"),e.computerPlay(),n.appendChild(t)}),p.addEventListener("click",()=>{o.style.transform="translate(0px, 40px)",o.style.opacity="0.5",l.style.transform="translate(0px, 40px)",l.style.opacity="0.5",p.style.transform="translate(0px, -70px)",p.style.opacity="1";let t=document.createElement("custom-piedra");e.setMove("piedra"),e.computerPlay(),n.appendChild(t)}),l.addEventListener("click",()=>{o.style.transform="translate(0px, 40px)",o.style.opacity="0.5",l.style.transform="translate(0px, -70px)",l.style.opacity="1",p.style.transform="translate(0px, 40px)",p.style.opacity="0.5";let t=document.createElement("custom-papel");e.setMove("papel"),e.computerPlay(),n.appendChild(t)}),document.body.appendChild(n),n.style.display="none",a.appendChild(i),a}},{path:/\/result/,component:function(t){let a=document.createElement("div"),n="",i=e.data.currentGame.myPlay,s=e.data.currentGame.computerPlay,r=e.whoWins(i,s);n="Ganaste"==r?"gane":"Empate"==r?"empate":"perdi";let o=document.createElement("style");a.innerHTML=`
    <div class="main-resultado-${r}"> 
  ...
  `;let l=a.querySelector(".button-volver");return l?.addEventListener("click",()=>{t.goTo("/welcome")}),a.appendChild(o),a}}];!function(e){function a(e){history.pushState({},"",e),n(e)}function n(n){for(let i of(console.log("El handleRoute recibio una nueva ruta",n),t))if(i.path.test(n)){let t=i.component({goTo:a});e?.firstChild&&e.firstChild.remove(),e?.appendChild(t)}}"/"==location.pathname?a("/welcome"):n(location.pathname),window.onpopstate=function(){n(location.pathname)}}(document.querySelector(".root")),customElements.define("custom-piedra",class extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.getAttribute("variant")||"body",t=this.attachShadow({mode:"open"}),a=document.createElement("div"),n=document.createElement("style"),i=document.createElement("img");i.src="https://i.ibb.co/jvsry3t5/piedra-1.png",i.className=e,n.innerHTML=`
            .seleccion-piedra{
                width: 104px;
                height: 238px;
...
//# sourceMappingURL=index.63bfe3e7.js.map
